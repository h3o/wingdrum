...
//#define I2S_AUDIOFREQ 42318	//real rate by APLL (when 44.1k requested) -> good for reverb + wavetable drum
...
#define CODEC_BUF_LEN_DEFAULT		256//128//64
...
#define TIMING_EVERY_250_NS		sampleCounter%(I2S_AUDIOFREQ/4000)	//4000Hz	0-12
#define TIMING_EVERY_500_NS		sampleCounter%(I2S_AUDIOFREQ/2000)	//2000Hz	0-25
#define TIMING_EVERY_1_MS		sampleCounter%(I2S_AUDIOFREQ/1000)	//1000Hz	0-50
#define TIMING_EVERY_2_MS		sampleCounter%(I2S_AUDIOFREQ/500)	//500Hz		0-101
